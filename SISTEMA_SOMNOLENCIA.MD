...
```
    ...
    ║  ┌─────────────────────────────────────────────────────────────────┐  ║
    ║  │                                                                  │ ║
    ║  │  📍 Capa de extracción de puntos                                 │ ║
    ║  │  ├── 👁️ Procesador de malla facial (468 puntos de referencia)    │ ║
    ║  │  └── 🤲 Procesador de manos (21 puntos de referencia × 2 manos)  │ ║
    ║  │                                                                  │ ║
    ║  │  📊 Capa de procesamiento de datos                               │ ║
    ║  │  ├── 👁️ Procesador de ojos (Distancias euclidiana)               │ ║
    ║  │  ├── 👄 Procesador bucal (Apertura labial)                       │ ║
    ║  │  ├── 🎯 Procesador de cabezal (Ángulo de paso)                   │ ║
    ║  │  └── ✋ Procesador de manos (Proximidad a ojos)                  │ ║
    ║  │                                                                  │ ║
    ║  │  🎯 Capa de detección de características                         │ ║
    ║  │  ├── 👁️ Flicker & Microsleep (Contador de parpadeos)             │ ║
    ║  │  ├── 🥱 Detección de Bostezos (Duración de bostezos)             │ ║
    ║  │  ├── 🙇 Detección de cabeceo                                     │ ║
    ║  │  └── 🤲 Detección de frotamiento de ojos (Frotamiento de ojos)   │ ║
    ║  │                                                                  │ ║
    ║  │  📈 Capa de informes y visualización                             │ ║
    ║  │  ├── 📊 Generador de informes (CSV y JSON)                       │ ║
    ║  │  └── 🎨 Alertas visuales (superposición en vídeo)                │ ║
    ║  │                                                                  │ ║
    ║  └─────────────────────────────────────────────────────────────────┘  ║
    ╚═══════════════════════════╤═══════════════════════════════════════════╝
                                │
