...
import { useWebSocket } from '../../features/monitoring/hooks/useWebSocket';
import { useCamera } from '../../features/monitoring/hooks/useCamera';
import { VideoDisplay } from '../../features/monitoring/components/VideoDisplay';
import { ErrorMessage } from '../../features/monitoring/components/ErrorMessage';
import type { WebSocketResponse } from '../../features/monitoring/types';
        ...
        <div className="min-h-screen flex flex-col p-8">
            ...
            <div className="max-w-7xl mx-auto w-full mb-6">
                <nav className="flex items-center text-sm text-gray-600 mb-4">
                    ...
                    <span className="text-gray-900 font-medium">Monitoreo en Vivo</span>
                </nav>
            </div>
